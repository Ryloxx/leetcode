...
if __name__ == "__main__":
    run(MethodType(Solution.partition, Solution()), [
        [[ListNode.create_list([1, 4, 3, 2, 5, 2]), 3],
         ListNode.create_list([1, 2, 2, 4, 3, 5])],
        [[ListNode.create_list([5, 4, 3, 2, 1]), 3],
         ListNode.create_list([2, 1, 5, 4, 3])],
        [[ListNode.create_list([3]), 3],
         ListNode.create_list([3])],
        [[ListNode.create_list([2]), 3],
         ListNode.create_list([2])],
        [[ListNode.create_list([4]), 3],
         ListNode.create_list([4])],
        [[ListNode.create_list([-5, -4, -3, -2, -1]), 3],
         ListNode.create_list([-5, -4, -3, -2, -1])],
        [[ListNode.create_list([-5, -4, -3, -2, -1]), -3],
         ListNode.create_list([-5, -4, -3, -2, -1])],
        [[ListNode.create_list([-1, -2, -3, -4, -5]), -3],
